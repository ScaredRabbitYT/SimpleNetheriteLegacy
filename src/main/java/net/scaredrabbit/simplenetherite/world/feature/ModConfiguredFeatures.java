...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreFeatureConfig.Target> overworldNetheriteOres =
                List.of(OreFeatureConfig.createTarget(deepslateReplaceables, ModBlocks.DEEPSLATE_NETHERITE_ORE.getDefaultState()));
        ...
        register(context, OVERWORLD_NETHERITE_ORE_KEY, Feature.ORE, new OreFeatureConfig(overworldNetheriteOres,8));
        register(context, END_NETHERITE_ORE_KEY, Feature.ORE, new OreFeatureConfig(endNetheriteOres,6));
    }

    public static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, new Identifier(SimpleNetherite.MOD_ID, name));
    }
